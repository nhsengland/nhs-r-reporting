...
<style>
    ...
    .colourRegion tr:nth-child(1) { background: #78BE20; color: #231f20;}
    .colourRegion tr:nth-child(2) { background: #FAE100; color: #231f20;}
    .colourRegion tr:nth-child(3) { background: #ED8B00; color: #231f20;}
    .colourRegion tr:nth-child(4) { background: #AE2573; color: #FFFFFF;}
    .colourRegion tr:nth-child(5) { background: #330072; color: #FFFFFF;}
    .colourRegion tr:nth-child(6) { background: #41B6E6; color: #FFFFFF;}
    .colourRegion tr:nth-child(7) { background: #005EB8; color: #FFFFFF;}
</style>
