...
- These interactive html reports can be confiugured with parameters to create multiple versions of the same report, charts, and analyses but for different organisations
  ...
  - PCN / GP
  - Trust / Ward etc
- Using [{targets}](https://books.ropensci.org/targets/) we can define dependencies in the data processing stages and process these reports automatically when new data is avaiable. 
