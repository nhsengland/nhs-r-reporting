...
<style>
    ...
    .colourRegion tr:nth-child(0) { background: #FFFFFF; color: #231f20;}
    .colourRegion tr:nth-child(1) { background: #E69F00; color: #FFFFFF;}
    .colourRegion tr:nth-child(2) { background: #3DB4F5; color: #FFFFFF;}
    .colourRegion tr:nth-child(3) { background: #087558; color: #FFFFFF;}
    .colourRegion tr:nth-child(4) { background: #EADC17; color: #231f20;}
    .colourRegion tr:nth-child(5) { background: #6F7D86; color: #FFFFFF;}
    .colourRegion tr:nth-child(6) { background: #6F00D5; color: #FFFFFF;}
    .colourRegion tr:nth-child(7) { background: #820F25; color: #FFFFFF;}
</style>
